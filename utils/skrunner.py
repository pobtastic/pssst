...
PSSST_HOME = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
PSSST_SKOOL = '{}/sources/pssst.skool'.format(PSSST_HOME)
...
def run_skool2html():
    options = '-d {}/build/html'.format(PSSST_HOME)
